...
public class Field {
     ...
     */
    public Field(int rowCount, int columnCount, int mineCount,long startTime) { ////////////
    ...
    public void finishTime(long endTime,String sweep){
    	FinalTime = (endTime-startTime)/1000;
    	ScoreService service = new ScoreService();
    	service.skuska(FinalTime, sweep);
